...
public class NhutMVoTestAvgDistProxFeatureDSM extends ApplicationSetupBasedTest {
	@Test
	public void testOneDocTwoTerms() throws Exception {

		// make an index with a single sample document
		ApplicationSetup.setProperty("termpipelines", "");
		Index index = IndexTestUtils.makeIndexBlocks(new String[] { "doc1" }, new String[] {
				"The quick brown fox jumps over the lazy dog The quick brown fox brown dog jumps over brown fox." });
		...
		NhutMVoAvgDistProxFeatureDSM sample = new NhutMVoAvgDistProxFeatureDSM();
		...
		assertEquals(6.11d, score, 0.05d);
	}
}
