...
/**
 * You should use this sample class to implement a Simple TF*IDF weighting model
 * for Exercise 1 of the exercise. You can tell Terrier to use your weighting
 * model by specifying the property
 * trec.model=uk.ac.gla.dcs.models.MyWeightingModel NB: There is a corresponding
 * unit test that you should also complete to test your model.
 * 
 * @author TODO
 */
public class MyWeightingModel extends WeightingModel {
	...
	public double score(double tf, double docLength) {
		// you should implement this method to return a score for a term occurring tf
		// times in a document of docLength tokens.
...
//		double tfScore = 1 + Math.log(tf / docLength);
//		double idfScore = Math.log(((numberOfDocuments - documentFrequency) + 0.5) / (documentFrequency + 0.5));
//		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
//		System.out.println("tfScore :"+tfScore);
//		System.out.println("idfScore :"+idfScore);
		double tfScore = 1 + Math.log10(tf / docLength);
		double idfScore = Math.log10(((numberOfDocuments - documentFrequency) + 0.5) / (documentFrequency + 0.5));
//		System.out.println("tfScore :"+tfScore);
//		System.out.println("idfScore :"+idfScore);
